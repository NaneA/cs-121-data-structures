...
public abstract class AbstractTree<E> implements Tree<E> {
    ...
    public Position<E> LCA(Position<E> a, Position<E> b) throws IllegalArgumentException {
        int aH = depth(a);
        int bH = depth(b);

        //make sure that depth(a) > depth(b), since we don't want to write that same logic two times :D
        if (aH < bH) {
            Position<E> temp = a;
            a = b;
            b = temp;
        ...
        throw new IllegalArgumentException("No common ancestor! So you can marry :D ");
    }
}

...
public abstract class AbstractBinaryTree<E> extends AbstractTree<E>
  ...
  public boolean isRoman(Position<E> node) {
      return Math.abs(numDescendants(left(node))-numDescendants(right(node))) <= 5;
  }

//  public SinglyLinkedList<Position<E>> roman(Position<E> root, SinglyLinkedList<Position<E>> list) {
//    if(root == null) {
//      return null;
//    }
...
//
//    if(left(root) != null) {
//      roman(left(root), list);
//      left = left(root).size;
//      isLeftRoman = left(root).isRoman;
//    }
//
//
//    if(right(root) != null) {
//      roman(right(root), list);
//      right = right(root).size;
//      isRightRoman = right(root).isRoman;
//    }
//
